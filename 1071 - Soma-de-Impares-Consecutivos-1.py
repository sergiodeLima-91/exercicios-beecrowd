...
maior = entrada1 if entrada1 > entrada2 else entrada2 # > A variável "maior" vai receber o valor de "entrada1" caso
# a mesma variável "entrada1" seja maior que "entrada2". O contrário vai significar que o valor de "entrada2" é maior
# e ele será atribuído a variável "maior".
